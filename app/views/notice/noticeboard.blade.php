@extends('layouts.layout') @section('mycssfile') @stop @section('myjsfile')
				...
				<form>
					<div class="tabarea">
                        ...
                        <div class="notice_board_main">
                                ...
                                <ul>
                                        <li style="width:15%;" data-tabno="1"><a href="javascript:void(0)"  class="tab_active">Board1</a></li>
                                        <li style="width:15%;" data-tabno="2" ><a href="javascript:void(0)">Board2</a></li>
                                        <li style="width:30%;" data-tabno="3"><a href="javascript:void(0)">Staff Holidays & Time off</a></li>
                                        <li style="width:20%;" data-tabno="4" ><a href="javascript:void(0)">Excel Viewer</a></li>
                                        <li style="width:20%;" data-tabno="5"><a href="javascript:void(0)" class="last_align">PDF Viewer</a></li>
                                        </ul>
                                </div>
                        </div>
...
<div class="bottom_content">
        ...
        <p class="posted_t">Posted/Uplaod by {{ $userfullname->fname }} {{ $userfullname->lname}} {{ $val['created']}}</p>
        
        <div class="edit_controlar">
<a data-template_id="{{ $val['noticefont_id'] }}" onclick="openModal('{{ $val['noticefont_id'] }}')"><img src="img/edit_icon.png"  /></a>
...
<div class="bottom_content">
        ...
        <p class="posted_t">Posted/Uplaod by {{ $userfullname->fname }} {{ $userfullname->lname}} {{ $val2['created']}}</p>
        
        <div class="edit_controlar">
<a data-template_id="{{ $val2['noticefont_id'] }}" onclick="openModal('{{ $val2['noticefont_id'] }}')"><img src="img/edit_icon.png"  /></a>
...
{{ Form::open(array('url' => '/excel-upload', 'files' => true)) }}
...
FILE1<input type="file" name="add_file1" id="add_file1" >
</span>
</li>

<li>
<span class="btn btn-default btn-file" >
FILE2<input type="file" name="add_file2" id="add_file2">
</span>
</li>
<li>
<span class="btn btn-default btn-file">
FILE3<input type="file" name="add_file3" id="add_file3" >
</span>
</li>
<li>
<span class="btn btn-default btn-file">
FILE4<input type="file" name="add_file4" id="add_file4" >
</span> 
</li>
<li>
<span class="btn btn-default btn-file">
FILE5<input type="file" name="add_file5" id="add_file5" >
</span>
</li>
</ul>
</div>
