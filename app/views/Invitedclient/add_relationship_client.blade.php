...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <!-- Main content -->
    {{ Form::open(array('url' => '/relationship/insert-client-relationship', 'files' => true)) }}
...
<li>
<div class="form-group">
  <a href="/invitedclient-relationship" target="_blank" class="btn btn-info"><i class="fa fa-plus"></i> New InviteClient-Rel</a>
</div>
</li>
<li>
<div class="form-group">
  <a href="/invitedclient-details"target="_blank" class="btn btn-info"><i class="fa fa-plus"></i> New Invitedclient</a>
</div>
</li>
</ul>  
</div> 
...
<div class="clearfix"></div>
        ...
        <div class="email_btns">
          <button type="submit" class="btn btn-success pull-left save_t" name="save">Save</button>
